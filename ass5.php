...
// close connection
                ...
                <div class="col-11 p-0 ps-2 pt-2">
                    ...
                    $sql = "SELECT msgid, msgtitle, msgcontent,studentemail,studentemailre FROM msg WHERE msgid = '$msgid'";
                    $result = mysqli_query($conn, $sql);

                    if (mysqli_num_rows($result) > 0) {
                        // set a fixed width for the container div
                        echo "<form method='post' action='process_send.php'>";
                        while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <button type="submit" class="btn btn-block" style="background-color: #fdfdfd">Send</button>
                    </form>

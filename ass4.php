...
// close connection
                ...
                <div class="col-11 p-0 ps-2 pt-2">
                    ...
                    <?php
                    $sql = "SELECT msgid, msgtitle, msgcontent, studentemailre, studentemail 
        FROM msg 
        WHERE studentemail = '$studentemail' AND status = 'active' OR (studentemailre = '$studentemail' AND status = 'active')
        ORDER BY msgid DESC";

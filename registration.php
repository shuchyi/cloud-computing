...
<head>
    ...
    <title>SRC - event registration</title>
</head>

<body>
    <header>
        <?php
        include 'membereventheader.php'
        ?>
    ...
    <div class="container my-4">
        <a href="calendar1.php" class="square_btn" >Calendar</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a class='btn btn-success' href='mycart.php?id=".$row['id']."&price=".$row['price']."' onclick='showAlert()'>Register Now</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>

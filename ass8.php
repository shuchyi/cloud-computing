                ...
                <div class="col-11 p-0 ps-2 pt-2">
                    ...
                    <form action="process_new.php" method="post">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input required type="text" name='title' class="form-control me-3" placeholder="Title here" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class = 'form-floating me-3 mb-1'>
                            <textarea required name='comment' class = 'form-control' placeholder = 'Leave a comment here' id = 'floatingTextarea2'
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input required type="email" name='reemail' class="form-control me-3" placeholder="abc123@gmail.com" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
